...
GOLDdata = yf.download('GC=F', start='2016-01-01',end='2017-01-01')

GOLDdata.to_csv('GOLD2016.csv')

gold = pd.read_csv('GOLD2016.csv', index_col=0)
...
combine.to_csv('GOLD-FFR2016.csv')

import matplotlib.pyplot as plt
from sklearn.preprocessing import MinMaxScaler, StandardScaler

GOLDandFFR = pd.read_csv('GOLD-FFR2016.csv', index_col=0)
