...
GOLDdata = yf.download('GC=F', start='2020-01-01',end='2021-01-01')

GOLDdata.to_csv('GOLD2020.csv')

gold = pd.read_csv('GOLD2020.csv', index_col=0)
...
combine.to_csv('GOLD-FFR2020.csv')

import matplotlib.pyplot as plt
from sklearn.preprocessing import MinMaxScaler, StandardScaler

GOLDandFFR = pd.read_csv('GOLD-FFR2020.csv', index_col=0)
