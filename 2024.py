...
GOLDdata = yf.download('GC=F', start='2024-01-01',end='2024-03-14')

GOLDdata.to_csv('GOLD2024.csv')

gold = pd.read_csv('GOLD2024.csv', index_col=0)
...
combine.to_csv('GOLD-FFR2024.csv')

import matplotlib.pyplot as plt
from sklearn.preprocessing import MinMaxScaler, StandardScaler

GOLDandFFR = pd.read_csv('GOLD-FFR2024.csv', index_col=0)
