...
GOLDdata = yf.download('GC=F', start='2017-01-01',end='2018-01-01')

GOLDdata.to_csv('GOLD2017.csv')

gold = pd.read_csv('GOLD2017.csv', index_col=0)
...
combine.to_csv('GOLD-FFR2017.csv')

import matplotlib.pyplot as plt
from sklearn.preprocessing import MinMaxScaler, StandardScaler

GOLDandFFR = pd.read_csv('GOLD-FFR2017.csv', index_col=0)
