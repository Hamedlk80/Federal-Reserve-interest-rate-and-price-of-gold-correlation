...
GOLDdata = yf.download('GC=F', start='2011-01-01',end='2012-01-01')

GOLDdata.to_csv('GOLD2011.csv')

gold = pd.read_csv('GOLD2011.csv', index_col=0)
...
combine.to_csv('GOLD-FFR2011.csv')

import matplotlib.pyplot as plt
from sklearn.preprocessing import MinMaxScaler, StandardScaler

GOLDandFFR = pd.read_csv('GOLD-FFR2011.csv', index_col=0)
